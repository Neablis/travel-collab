...
| M30 | Notebooks with one job each, and links between them | **Minted and built 2026-09-26 by Mitchell, unplaced.** Four seeded notebooks (Overview as a letter and printed itinerary, Before you go, Bookings, Money) and two link widgets that store ids (ADR-056): `M30-notebooks-and-links.md` |
