...
| M29 | The time river | **In flight, not current** (minted 2026-09-26; M14 stays current). SPEC §36.9/§36.9b in four stacked PRs; part 1 is `pendingReason` (ADR-055): `M29-time-river.md` |
