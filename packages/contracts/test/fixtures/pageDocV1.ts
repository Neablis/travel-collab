...
//
// **FROZEN as of 2026-09-04**, when `pageDocV2.ts` landed beside it — that is
// the rule this file's own header set, and it is now in force. Nothing below
// changes again: it is what a row written before ADR-039 actually contains, and
// the only thing that can prove the v1 → v2 migration reads one correctly.
//
// It grew once before it froze, and that is worth keeping: it
