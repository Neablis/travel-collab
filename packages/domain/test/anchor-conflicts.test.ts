...
function dated(startDate: string | null, anchors: Anchor[], timeWindow: TripState["activities"][string]["timeWindow"] = null): TripState {
  return {
    ...
    activities: { [A1]: { title: "Market", timeWindow, location: null, notes: null, anchors, kind: "planned" as const, tags: [], cost: null, bookedBy: null, participants: [], mode: null, endLocation: null, pendingReason: null } },
