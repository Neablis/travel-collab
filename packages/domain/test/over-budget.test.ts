...
function stateWith(budgetMinor: number | null, costMinor: number): TripState {
  return {
    ...
    activities: { [A1]: { title: "Hotel", timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: { amountMinor: costMinor, currency: "USD" } , bookedBy: null, participants: []} },
