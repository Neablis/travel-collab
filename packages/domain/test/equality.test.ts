...
const base: TripState = {
  ...
  activities: {
    "7d9a1f8e-0000-4000-8000-0000000000a1": { title: "Colosseum", timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null, bookedBy: null, participants: [], mode: null, endLocation: null },
  },
...
describe("tripStatesEqual", () => {
  it("is true for structurally identical states regardless of activity key order", () => {
    const twoActivities = {
      ...
      activities: {
        ...base.activities,
        "7d9a1f8e-0000-4000-8000-0000000000a2": { title: "Vatican", timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null, bookedBy: null, participants: [], mode: null, endLocation: null },
      },
    };
    const reversedKeys = {
      ...twoActivities,
