...
function conflictedState(): TripState {
  return {
    ...
    backlog: [],
    activities: {
      [A1]: { title: "Colosseum", timeWindow: { start: "09:00", end: "11:00" }, location: null, notes: null, anchors: [], kind: "planned", tags: [], cost: null },
      [A2]: { title: "Vatican", timeWindow: { start: "10:00", end: "12:00" }, location: null, notes: null, anchors: [], kind: "planned", tags: [], cost: null },
    },
