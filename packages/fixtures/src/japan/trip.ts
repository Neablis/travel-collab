...
//
// `tags`, `lat`/`lng`, `mode`/`endsAt` (M24) and the backlog's `city` are OURS — the export carries
...
export type JapanStop = {
  ...
  kind: ActivityKind;
  tags: ActivityTag[];
  /** Whole USD, as the export's estimator produced it. `null` = a stop the
   *  export marked "idea", with no estimate yet. Converted to minor units in
   *  commands.ts. */
  costUsd: number | null;
  note: string | null;
  ...
  lat: number;
  lng: number;
  /** How a `transit` stop travels (M24). Ours, like `tags`: the export has no such field. */
  mode?: ActivityMode;
  /**
   * Where a `transit` stop's leg ENDS, named as the id of another row whose
   * place it arrives at — "Shinkansen Odawara → Kyoto" ends at the Kyoto
   * Station row. A reference rather than a place of its own so every
   * `endLocation` coordinate is one this file already carries and verifies,
   * never one typed from memory (KI-39). Set only where the from/to is
   * obvious and the destination is a place the trip visits; a leg into
   * somewhere the fixture has no row for (Tokyo Station, Hakone-Yumoto) or a
...
export const JAPAN_STOPS: readonly JapanStop[] = [
  ...
  { id: "d2-s2-teamlab-planets", day: 2, title: "teamLab Planets", place: "teamLab Planets", area: "Toyosu", city: "Tokyo", start: "09:00", end: "11:00", kind: "planned", tags: ["ticketed"], costUsd: 355, note: "Timed entry 9 am. Barefoot — no tights.", who: "all", lat: 35.6469, lng: 139.793 },
  ...
  { id: "d2-s5-yakitori-at-torishiki", day: 2, title: "Yakitori at Torishiki", place: "Torishiki", area: "Meguro", city: "Tokyo", start: "19:00", end: "21:00", kind: "planned", tags: ["meal"], costUsd: 315, note: null, who: "all", lat: 35.6339, lng: 139.7157 },
  ...
  { id: "d3-s5-dinner-at-den", day: 3, title: "Dinner at Den", place: "Den", area: "Jingūmae", city: "Tokyo", start: "19:30", end: "21:30", kind: "planned", tags: ["meal"], costUsd: 260, note: "Held with a card. 48h cancellation.", who: "all", lat: 35.6688, lng: 139.7096 },

  // Day 4 — Nikkō
  { id: "d4-s1-limited-express-to-nikko", day: 4, title: "Limited Express to Nikkō", place: "Tobu Asakusa Station", area: "Asakusa", city: "Tokyo", start: "07:10", end: "09:10", kind: "transit", tags: [], costUsd: 100, note: null, who: "all", lat: 35.7107, lng: 139.8017, mode: "train", endsAt: "d4-s5-train-back-to-tokyo" },
  ...
  { id: "d4-s5-train-back-to-tokyo", day: 4, title: "Train back to Tokyo", place: "Tobu Nikkō Station", area: "Nikkō", city: "Nikkō", start: "18:30", end: "20:30", kind: "transit", tags: [], costUsd: 135, note: null, who: "all", lat: 36.7578, lng: 139.6122, mode: "train", endsAt: "d4-s1-limited-express-to-nikko" },
  ...
  { id: "d5-s5-omakase-at-sushi-yoshitake", day: 5, title: "Omakase at Sushi Yoshitake", place: "Sushi Yoshitake", area: "Ginza", city: "Tokyo", start: "20:00", end: "22:00", kind: "planned", tags: ["meal"], costUsd: 155, note: "Concierge is chasing this one.", who: "all", lat: 35.671, lng: 139.7638 },

  // Day 6 — Hakone
  { id: "d6-s1-romancecar-to-hakone-yumoto", day: 6, title: "Romancecar to Hakone-Yumoto", place: "Shinjuku Station", area: "Shinjuku", city: "Tokyo", start: "08:20", end: "09:55", kind: "transit", tags: [], costUsd: 35, note: null, who: "all", lat: 35.6896, lng: 139.7006, mode: "train" },
  { id: "d6-s2-hakone-open-air-museum", day: 6, title: "Hakone Open-Air Museum", place: "Open-Air Museum", area: "Ninotaira", city: "Hakone", start: "10:30", end: "12:30", kind: "planned", tags: ["ticketed", "outdoors"], costUsd: 475, note: null, who: "all", lat: 35.2444, lng: 139.0464 },
  ...
  { id: "d6-s4-check-in-at-gora-kadan", day: 6, title: "Check in at Gora Kadan", place: "Gora Kadan", area: "Gōra", city: "Hakone", start: "16:40", end: "17:10", kind: "planned", tags: ["lodging"], costUsd: 250, note: "Check-in closes at 16:00 — this is the conflict the assistant flagged.", who: "all", lat: 35.2379, lng: 139.0561 },
  { id: "d6-s5-kaiseki-dinner-at-the-ryokan", day: 6, title: "Kaiseki dinner at the ryokan", place: "Gora Kadan", area: "Gōra", city: "Hakone", start: "18:30", end: "20:30", kind: "planned", tags: ["meal"], costUsd: 320, note: null, who: "all", lat: 35.2379, lng: 139.0561 },

  // Day 7 — Kyoto
  { id: "d7-s1-shinkansen-odawara-kyoto", day: 7, title: "Shinkansen Odawara → Kyoto", place: "Odawara Station", area: "Odawara", city: "Odawara", start: "09:30", end: "11:45", kind: "transit", tags: [], costUsd: 30, note: null, who: "all", lat: 35.2547, lng: 139.1546, mode: "train", endsAt: "d11-s1-train-kyoto-osaka" },
  ...
  { id: "d8-s6-dinner-at-giro-giro-hitoshina", day: 8, title: "Dinner at Giro Giro Hitoshina", place: "Giro Giro Hitoshina", area: "Shimogyō", city: "Kyoto", start: "19:30", end: "21:30", kind: "planned", tags: ["meal"], costUsd: 90, note: null, who: "all", lat: 35.0028, lng: 135.7683 },
  ...
  { id: "d9-s5-dinner-at-kichi-kichi", day: 9, title: "Dinner at Kichi Kichi", place: "Kichi Kichi", area: "Pontochō", city: "Kyoto", start: "18:00", end: "19:30", kind: "planned", tags: ["meal"], costUsd: 495, note: null, who: "all", lat: 35.0069, lng: 135.771 },
  ...
  { id: "d10-s2-lunch-at-monk", day: 10, title: "Lunch at Monk", place: "Monk", area: "Sakyō", city: "Kyoto", start: "11:30", end: "12:30", kind: "planned", tags: ["meal"], costUsd: 500, note: null, who: "all", lat: 35.0271, lng: 135.7936 },
  ...
  // Day 11 — Osaka
  { id: "d11-s1-train-kyoto-osaka", day: 11, title: "Train Kyoto → Osaka", place: "Kyoto Station", area: "Shimogyō", city: "Kyoto", start: "10:00", end: "10:40", kind: "transit", tags: [], costUsd: 190, note: null, who: "all", lat: 34.9858, lng: 135.7588, mode: "train", endsAt: "d14-s2-shinkansen-to-tokyo" },
  { id: "d11-s2-check-in-at-zentis-osaka", day: 11, title: "Check in at Zentis Osaka", place: "Zentis Osaka", area: "Kita", city: "Osaka", start: "11:30", end: "12:00", kind: "planned", tags: ["lodging"], costUsd: 465, note: null, who: "all", lat: 34.6971, lng: 135.4938 },
  ...
  { id: "d13-s2-chichu-art-museum", day: 13, title: "Chichū Art Museum", place: "Chichū Art Museum", area: "Naoshima", city: "Naoshima", start: "10:30", end: "12:30", kind: "planned", tags: ["ticketed"], costUsd: 340, note: "Timed ticket 10:30 am. Late arrivals are turned away.", who: "all", lat: 34.459, lng: 133.995 },
  { id: "d13-s3-lunch-at-aisunao", day: 13, title: "Lunch at Aisunao", place: "Aisunao", area: "Honmura", city: "Naoshima", start: "13:00", end: "14:00", kind: "planned", tags: ["meal"], costUsd: 95, note: null, who: "all", lat: 34.4602827, lng: 133.9951957 },
  ...
  { id: "d13-s5-ferry-and-train-back-to-osaka", day: 13, title: "Ferry and train back to Osaka", place: "Miyanoura Port", area: "Naoshima", city: "Naoshima", start: "17:30", end: "20:30", kind: "transit", tags: [], costUsd: 180, note: null, who: "all", lat: 34.4614, lng: 133.9782, mode: "ferry" },
  ...
  { id: "d14-s2-shinkansen-to-tokyo", day: 14, title: "Shinkansen to Tokyo", place: "Shin-Osaka Station", area: "Yodogawa", city: "Osaka", start: "09:30", end: "11:45", kind: "transit", tags: [], costUsd: 140, note: null, who: "all", lat: 34.7333, lng: 135.5002, mode: "train" },
  ...
  { id: "d14-s4-transfer-to-haneda", day: 14, title: "Transfer to Haneda", place: "HND Terminal 3", area: "Ōta", city: "Tokyo", start: "16:30", end: "18:00", kind: "planned", tags: [], costUsd: 175, note: null, who: "all", lat: 35.5494, lng: 139.7798 },
  { id: "d14-s5-flight-home", day: 14, title: "Flight home", place: "HND Terminal 3", area: "Ōta", city: "Tokyo", start: "20:10", end: "21:00", kind: "planned", tags: [], costUsd: 160, note: "Check-in opens 5:10 pm.", who: "all", lat: 35.5494, lng: 139.7798 },
];
