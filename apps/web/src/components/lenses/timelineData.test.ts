...
const detail: TripDetail = {
  ...
  activities: {
    [A1]: { activityId: A1, title: "Museum", timeWindow: { start: "09:00", end: "11:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
    [A2]: { activityId: A2, title: "Wander", timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
  },
