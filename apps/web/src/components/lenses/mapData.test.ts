...
const detail: TripDetail = {
  ...
  activities: {
    [A1]: { activityId: A1, title: "Colosseum", timeWindow: null, location: { name: "Colosseum", lat: 41.89, lng: 12.49 }, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null, pendingReason: null},
    [A2]: { activityId: A2, title: "Idea", timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null, pendingReason: null},
  },
...
describe("map data", () => {
  ...
  it("lists a day-attached activity that has no location", () => {
    ...
    const withDayAttached: TripDetail = {
      ...
      activities: {
        ...detail.activities,
        [A3]: { activityId: A3, title: "Museum", timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null, pendingReason: null},
      },
    };
