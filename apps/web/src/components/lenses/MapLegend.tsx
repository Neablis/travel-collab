...
// Handoff `current/…dc.html:630-668` "legend": a floating pill, bottom-right.
...
export function MapLegend() {
  return (
    <div
      ...
      // eslint-disable-next-line no-restricted-syntax -- computed position/z-index (18px right/bottom, z 45) and 11px legend text have no token equivalent, matching AssistantRail's computed-geometry pattern
      style={{ right: "18px", bottom: "18px", zIndex: 45, fontSize: "11px" }}
    >
