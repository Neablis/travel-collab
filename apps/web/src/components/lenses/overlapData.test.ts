...
const detail = (over: Partial<TripDetail> = {}): TripDetail =>
  tripDetailFixture({
    ...
    activities: {
      a: { activityId: "a", title: "Nezu Museum", timeWindow: { start: "10:30", end: "13:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null},
      b: { activityId: "b", title: "Lunch at Kagari", timeWindow: { start: "12:30", end: "14:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null},
    },
    conflicts: [
      {
...
describe("overlapsForDay", () => {
  ...
  it("offers no end when the duration-preserving move would run past midnight", () => {
    const d = detail({
      activities: {
        a: { activityId: "a", title: "Nezu Museum", timeWindow: { start: "20:00", end: "23:45" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null},
        b: { activityId: "b", title: "Lunch at Kagari", timeWindow: { start: "23:30", end: "23:59" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null},
      },
    });
  ...
  it("still offers a move that lands exactly on the day's last minute", () => {
    const d = detail({
      activities: {
        a: { activityId: "a", title: "Nezu Museum", timeWindow: { start: "20:00", end: "23:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null},
        b: { activityId: "b", title: "Lunch at Kagari", timeWindow: { start: "22:30", end: "23:29" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null},
      },
    });
  ...
  it("breaks a same-start tie on the later end, so the pair still resolves deterministically", () => {
    const d = detail({
      activities: {
        a: { activityId: "a", title: "Nezu Museum", timeWindow: { start: "10:30", end: "13:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null},
        b: { activityId: "b", title: "Lunch at Kagari", timeWindow: { start: "10:30", end: "11:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null},
      },
    });
    const [o] = overlapsForDay(d, "d1");
