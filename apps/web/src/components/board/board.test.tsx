...
function fixture() {
  return tripDetailFixture({
    ...
    activities: {
      [A1]: { activityId: A1, title: "Colosseum", timeWindow: { start: "09:00", end: "11:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
      [A2]: { activityId: A2, title: "Vatican Museums", timeWindow: { start: "10:00", end: "12:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
    },
    conflicts: [
      {
...
function threeWayOverlapFixture() {
  ...
  return tripDetailFixture({
    ...
    activities: {
      [A1]: { activityId: A1, title: "Colosseum", timeWindow: { start: "09:00", end: "12:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
      [A2]: { activityId: A2, title: "Vatican Museums", timeWindow: { start: "10:00", end: "13:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
      [A3]: { activityId: A3, title: "Trastevere walk", timeWindow: { start: "11:00", end: "14:00" }, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
    },
    conflicts: [
    ...
    renderBoard(
      tripDetailFixture({
        ...
        activities: Object.fromEntries(
          ids.map((id, i) => [
            id,
            { activityId: id, title: `Stop ${i + 1}`, timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
          ]),
        ),
      }),
      noopCallbacks(),
