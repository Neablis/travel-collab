...
function activity(activityId: string, timeWindow: { start: string; end: string } | null): ActivityView {
  return { activityId, title: activityId, timeWindow, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null, pendingReason: null};
}
