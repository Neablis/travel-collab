...
function activity(id: string, title: string): ActivityView {
  return { activityId: id, title, timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: [], mode: null, endLocation: null};
}
