...
export const PREVIEW_REGISTRY = {
  ...
  "trip-invites": { milestone: "M11", wiredUpBy: "M11 invites — TripMember.role carries owner|editor|viewer, but nothing creates a non-owner member yet" },
  ...
  "wizard-invite-list": { milestone: "M11", wiredUpBy: "M11 invites — TripMember.role carries owner|editor|viewer, but nothing creates a non-owner member yet" },
