...
function activity(activityId: string, title: string, timeWindow: { start: string; end: string } | null) {
  return { activityId, title, timeWindow, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []};
}
...
describe("resolveBatch — errors are per-command, not fatal to the batch", () => {
  ...
  it("drops an ambiguous activity ref without guessing", () => {
    ...
    const detail = tripDetailFixture({
      ...
      activities: {
        [a]: { activityId: a, title: "Park", timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
        [b]: { activityId: b, title: "Park", timeWindow: null, location: null, notes: null, anchors: [], kind: "planned" as const, tags: [], cost: null , bookedBy: null, participants: []},
      },
    });
